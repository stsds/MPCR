...
RGreaterThanDispatcher(DataType *apInputA, SEXP aObj) {
    ...
    if (TYPEOF(aObj) == REALSXP || TYPEOF(aObj) == INTSXP) {
        ...
        return RGreaterThan(apInputA, val);
        ...
        return RGreaterThan(apInputA, temp_mpr);
    }
}
...
RGreaterThanOrEqualDispatcher(DataType *apInputA, SEXP aObj) {
    ...
    if (TYPEOF(aObj) == REALSXP || TYPEOF(aObj) == INTSXP) {
        auto val = Rcpp::as <double>(aObj);
        return RGreaterThanOrEqual(apInputA, val);
        ...
        return RGreaterThanOrEqual(apInputA, temp_mpr);
    }
}
...
RLessThanDispatcher(DataType *apInputA, SEXP aObj) {
    ...
    if (TYPEOF(aObj) == REALSXP || TYPEOF(aObj) == INTSXP) {
        ...
        return RLessThan(apInputA, temp_mpr);
    }
}
...
RLessThanOrEqualDispatcher(DataType *apInputA, SEXP aObj) {
    ...
    if (TYPEOF(aObj) == REALSXP || TYPEOF(aObj) == INTSXP) {
        auto val = Rcpp::as <double>(aObj);
        return RLessThanOrEqual(apInputA, val);
        ...
        return RLessThanOrEqual(apInputA, temp_mpr);
    }
}
...
REqualDispatcher(DataType *apInputA, SEXP aObj) {
    ...
    if (TYPEOF(aObj) == REALSXP || TYPEOF(aObj) == INTSXP) {
        ...
        return REqual(apInputA, temp_mpr);
    }
}
...
RNotEqualDispatcher(DataType *apInputA, SEXP aObj) {
    ...
    if (TYPEOF(aObj) == REALSXP || TYPEOF(aObj) == INTSXP) {
        ...
        return RNotEqual(apInputA, temp_mpr);
    }
}
