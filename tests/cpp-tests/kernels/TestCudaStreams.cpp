...
TEST_CUDA_STREAMS() {
    ...
    SECTION("Test Asynchronous GPU context without synchronization") {
        ...
        auto gpu_context_async = context_manager.CreateRunContext();
    ...
    SECTION("Test Synchronous GPU context") {
        ...
        auto gpu_context_sync = context_manager.CreateRunContext();
    ...
    SECTION("Test Asynchronous and Synchronous GPU contexts") {
        ...
        auto& context_manager = mpcr::kernels::ContextManager::GetInstance();
        auto default_context = context_manager.GetOperationContext();
        auto gpu_context_async1 = context_manager.CreateRunContext();
        auto gpu_context_async2 = context_manager.CreateRunContext();
