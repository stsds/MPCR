...
set(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG}  -xHost -g -debug -O0 -ffast-math  -fma -qopt-report=max")
set(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE}  -xHost -O3 -ffast-math -fma -qopt-report=max")
message(STATUS "${Green}Using Intel Compiler${ColourReset}")