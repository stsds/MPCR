...
run_backsolve_benchmark <- function(n, replication, times) {
  ...
  MPCR_single_U <- as.MPCR(U, n, n, "single")
  MPCR_double_U <- as.MPCR(U, n, n, "double")


  MPCR_single_b <- as.MPCR(b, n, n, precision = "single")
  MPCR_double_b <- as.MPCR(b, n, n, precision = "double")
...
run_forwardsolve_benchmark <- function(n, replication, times) {
  ...
  MPCR_single_L <- as.MPCR(L, n, n, "single")
  MPCR_double_L <- as.MPCR(L, n, n, "double")
