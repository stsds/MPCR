...
run_trsm_benchmark <- function(n, tile_size, replication, times) {
  ...
  MPCR_tile_single_U <- new(MPCRTile, n, n, tile_size, tile_size, U, precision_single)
  MPCR_tile_double_U <- new(MPCRTile, n, n, tile_size, tile_size, U, precision_double)

  print("Here")
  MPCR_tile_single_b <- new(MPCRTile, n,n, tile_size,tile_size, b, precision_single)
  MPCR_tile_double_b <- new(MPCRTile, n,n, tile_size,tile_size, b, precision_double)
  print("Here")

  cat("\n\n")
  cat("Running tile trsm benchmark \n")
  print(benchmark(replications = rep(replication, times),
                  MPCRTile.trsm(a = MPCR_tile_double_U, b = MPCR_tile_double_b, side = 'R', upper_triangle = TRUE, transpose = FALSE, alpha = 1),
                  MPCRTile.trsm(a = MPCR_tile_single_U, b = MPCR_tile_single_b, side = 'R', upper_triangle = TRUE, transpose = FALSE, alpha = 1),
